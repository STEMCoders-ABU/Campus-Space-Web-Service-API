	...
	public function add_resource()
	{
		try {
			...
			if ($moderator) {
				...
				$resource_id = $this->model->add_resource($entries);
				if ($resource_id) {
					...
					$moderator = $this->model->getModeratorData($moderator['username'], true);

					$email = \Config\Services::email();
					$email->setTo($emails);
					$email->setSubject('Campus Space Resource Update');
					$email->setMessage($this->getResourceUpdateEmailBody($resource_id, $moderator['department'], $moderator['level']));
					$email->send();
...
EMAIL;
	...
	private function getResourceUpdateEmailBody($resource_id, $department, $level) 
	{
		$year = \date('Y');
		$view_link = 'https://campus-space.com.ng/resource/' . $resource_id;
		$fb_img = \site_url('public/images/facebook2x.png');
		$tw_img = \site_url('public/images/twitter2x.png');
		...
		<div style="color:#393d47;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.5;padding-top:10px;padding-right:25px;padding-bottom:10px;padding-left:25px;">
		<div style="line-height: 1.5; font-size: 12px; color: #393d47; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px;">
		<p style="line-height: 1.5; word-break: break-word; text-align: left; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;">Hello!</span></p>
		<p style="line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 18px; margin: 0;"> </p>
		<p style="line-height: 1.5; word-break: break-word; text-align: left; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;">A new resource was just added in {$department}, {$level} level. Check it out!</span></p>
		</div>
		</div>
		<!--[if mso]></td></tr></table><![endif]-->
		<div align="center" class="button-container" style="padding-top:35px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
		<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 35px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{$view_link}" style="height:39pt; width:216.75pt; v-text-anchor:middle;" arcsize="49%" stroke="false" fillcolor="#ef233c"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a href="{$view_link}" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #ef233c; border-radius: 25px; -webkit-border-radius: 25px; -moz-border-radius: 25px; width: auto; width: auto; border-top: 0px solid #8a3b8f; border-right: 0px solid #8a3b8f; border-bottom: 0px solid #8a3b8f; border-left: 0px solid #8a3b8f; padding-top: 10px; padding-bottom: 10px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:35px;padding-right:35px;font-size:16px;display:inline-block;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">VIEW RESOURCE</span></span></a>
		<!--[if mso]></center></v:textbox></v:roundrect></td></tr></table><![endif]-->
		</div>
		<!--[if (!mso)&(!IE)]><!-->
		</div>
